...
product2 = ecommerce_platform.create_product(
    "electronics", "Headphones", 79.99, "Gadgets"
)
product3 = ecommerce_platform.create_product(
    "electronics", "iPhone", 1049.99, "Gadgets"
)
