...
# chaning to builder methods as return self as objects
small_house_builder.set_floor(9).set_wall(12).set_furniture("Chairs", 5).set_furniture(
    "Chairs", 4
...
big_house_builder.set_floor(24).set_roof(11).set_wall(45).set_furniture(
    "Sofa", 25
).set_furniture("Sofa", 5).set_furniture("Tables", 8)

big_house_builder.set_furniture("Cupboard", 4).set_furniture("Bed", 10)
# retrun house instances
big_house = big_house_builder.get_house()
print(big_house)

"""
Sperate construction of objects from its represenation
You can add another optionl Director class that can orchastete the
